...
using _2Movies.Application.Validators;
...
public class MovieService : IMovieService
{
    ...
    public MovieService(IRatingRepository ratingRepository, IMovieRepository movieRepository, IValidator<Movie> movieValidator, IValidator<GetAllMoviesOptions> optionsValidator)
    {
